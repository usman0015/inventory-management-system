...
<div class="form-page">
    <div class="page-header">
        <h4><i class="bi bi-plus-circle me-2 text-success"></i>Add New Item</h4>
    ...
    <div class="app-card form-card">
        ...
        <div class="app-card-body">
            <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data" data-loading>
                @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                <i class="bi bi-tag"></i>
                                <input type="text" id="itemName" name="name" value="{{ old('name') }}" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="e.g. Wireless Mouse">
                            </div>
                            @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="category" value="{{ old('category') }}" class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" placeholder="e.g. Electronics">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="quantity" value="{{ old('quantity') }}" min="0" class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" placeholder="e.g. 25">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" step="0.01" min="0" name="price" value="{{ old('price') }}" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" placeholder="e.g. 49.99">
                            </div>
                            @if ($errors->has('price'))
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" rows="4" placeholder="Describe the item in a few words...">{{ old('description') }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="field-hint" id="imageHint">No image selected.</div>
                    @if ($errors->has('image'))
